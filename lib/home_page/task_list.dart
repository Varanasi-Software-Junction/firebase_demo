                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                       ...
                       Text(widget.sub_title,style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                      Padding(
                        padding: const EdgeInsets.all(12.0),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                             Text(widget.category,style: const TextStyle(color: Colors.grey,fontSize: 17,fontWeight: FontWeight.bold),),
                      ...
                      Row(
                        children: [
                          const Column(
                            children: [
                              Padding(
                                ...
                                child: Icon(Icons.calendar_month,color: Colors.teal,size: 30,),
                              ),
                            ],
                          ),
                          ...
                          const Text("-"),
                          Text(widget.month,style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 16
                          ),),
                          const Text("-"),
